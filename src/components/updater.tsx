    ...
    return (
        ...
        >
            ...
            >
                ...
                >
                    A new version of Telea is ready to be installed.
                </motion.p>
                    ...
                    >
                        {currentVersion && (
                            <div className="flex flex-col items-center">
                                <span className="text-xs text-white/30 mb-1 select-none">Current</span>
                                <div className="px-3 py-1.5 rounded-lg bg-white/[0.04] border border-white/[0.08]">
                                    <span className="text-sm font-mono text-white/60 select-none">
                                        {currentVersion}
                                    </span>
                                </div>
                            </div>
                        ...
                        {currentVersion && newVersion && (
                            <RefreshCw className="size-4 text-white/60 mt-5" />
                        )}
                        {newVersion && (
                            <div className="flex flex-col items-center">
                                <span className="text-xs text-white/30 mb-1 select-none">New</span>
                                <div className="px-3 py-1.5 rounded-lg bg-purple-500/10 border border-purple-500/30">
                                    <span className="text-sm font-mono text-purple-400 select-none">
                                        {newVersion}
                                    </span>
                                </div>
                            </div>
                        ...
                        <AnimatePresence mode="wait">
                            {isDownloading ? (
                                ...
                                <motion.span
                                    ...
                                    className="flex items-center justify-center gap-2"
                                >
                                    Update now <Download className="size-4" />
                                </motion.span>
                            )}
                        </AnimatePresence>
                    </motion.button>
                ...
                {isDownloading && (
                    ...
                    >
                        Telea will restart automatically after installation.
                    </motion.p>
                )}
            </motion.div>
        </motion.div>
